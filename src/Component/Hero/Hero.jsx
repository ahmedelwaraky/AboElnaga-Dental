...
import { FaCalendarAlt, FaPhoneAlt, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
  ...
  const slides = [
    {
      ...
      description: "نقدم لك أفضل خدمات طب الأسنان بأحدث التقنيات العالمية وفريق من الأطباء المتخصصين لضمان ابتسامة صحية وجميلة",
    ...
    },
    {
      ...
      description: "نستخدم أحدث الأجهزة والمعدات العالمية لتقديم علاجات آمنة وفعالة بأقل ألم وأسرع وقت للتعافي",
    ...
    },
    {
      ...
      description: "يضم مركزنا نخبة من أمهر أطباء الأسنان في جميع التخصصات لتوفير رعاية شاملة تلبي احتياجاتك الخاصة",
